    ...
    <el-form ref="form" :model="form" label-width="100px" style="width: 95%">
      ...
      <el-row :gutter="25">
        <el-form-item label="昵称">
          <el-input v-model="form.nickName" style="width: 30%;" class="ant-form-item-control-input-content"></el-input>
        </el-form-item>
      </el-row>
      <el-row :gutter="25">
      ...
      <el-row>
        <el-form-item>
          <button type="button" class="ant-btn ant-btn-primary save-btn" style="width: 200px" @click="handleSubmit">保存</button>
        </el-form-item>
      </el-row>
    </el-form>
  </div>
